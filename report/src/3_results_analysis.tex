...
in fig.~\ref{fig_wavelengths}. In the next step we measured the distance of said points to the zero point 
in the grating pattern using the imtools method in matlab. This is our pixel distance $x$ in eq.~\ref{eq_distance}.
...
distance $x$ to the center point of the grating.
\begin{align}
